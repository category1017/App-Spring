...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);//화면랜더링 = 메모리로딩
        //-----------------------------------------------여기까지 기본--------
        //메인액티비티가 onCreate로 생성이 될때, 인텐트로 받은 값을 출력가능
        //
        Intent intent = new Intent(this.getIntent());
        String userId = intent.getStringExtra("editTextID");
        //Toast.makeText(MainActivity.this, "사용자ID는 : " + userId, Toast.LENGTH_SHORT).show();
        ...
        btnTel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //디버그 Toast.makeText(MainActivity.this, "전화걸기실행!", Toast.LENGTH_LONG).show();
    ...
    public void goToNaver(View view) {
        ...
        //jsp의 alert와 같은 기능을 하는 Toast토스트(식빵이 구워서 튀어나오는 모양)
